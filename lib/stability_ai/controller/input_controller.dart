...
class InputController extends GetxController {
  ...
  generateImage({required String text}) async {
    ...
    try {
      var response = await DioClient.postMethod(url: 'text-to-image', data: {
        "cfg_scale": 7,
        "height": 512,
        "width": 512,
    ...
    //       update();
    //
    //       debugPrint("image---> ${imageSource}");
    //
    //       // image=jsonDecode(response.data);
    //     } catch (e) {
  ...
  getData() async {
    try {
      var response = await DioClient.getMethod(
          isMockUrl: true,
          url: "https://api.stability.ai/v1/generation/stable-diffusion-v1-6/");
